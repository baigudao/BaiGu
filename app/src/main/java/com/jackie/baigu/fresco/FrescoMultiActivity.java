...
public class FrescoMultiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 先显示低分辨率的图，然后是高分辨率的图
        bt_fresco_multiImg.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // 本地缩略图预览
        bt_fresco_thumbnailImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 图片地址
        ...
        // 本地图片复用
        bt_fresco_multiplexImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //本地图片的复用
