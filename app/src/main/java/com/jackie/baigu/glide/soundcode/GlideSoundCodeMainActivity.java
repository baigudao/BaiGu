package com.jackie.baigu.glide.soundcode;
 ...
 */
public class GlideSoundCodeMainActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        setContentView(R.layout.sound_code_main_glide);
...
//                Toast.makeText(GlideSoundCodeMainActivity.this, "只要在build.gradle中加入：compile 'com.android.support:design:23.4.0'", Toast.LENGTH_LONG).show();
                break;
            case R.id.btn_remark:
//                Toast.makeText(GlideSoundCodeMainActivity.this, "《在清单文件中》：<activity\n" +
...
//                startActivity(new Intent(GlideSoundCodeMainActivity.this,MainSoundCodeActivity.class));
                break;
            default:
                break;
        }
