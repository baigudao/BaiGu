package com.jackie.baigu.imageloader.adapter;
...
import com.jackie.baigu.imageloader.Constants;
...
public class ImageloaderListviewAdapter extends BaseAdapter {
    ...
    class Viewholder {
        ...
        public Viewholder(View view) {
            iv = (ImageView) view.findViewById(R.id.iv_imageloader_listview);
            name = (TextView) view.findViewById(R.id.tv_imageloader_name);
        }
    }
}
